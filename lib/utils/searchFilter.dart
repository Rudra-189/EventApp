...
import '../views/User/search/searchControler.dart';
        ...
        child: Column(
          children: [
            ...
            SizedBox(
              ...
              child: ListView.builder(
                itemBuilder: (context, index) {
                  bool isSelected = controler.selectedCategories.contains(category);
                  return GestureDetector(
                    onTap: (){
                      setState(() {
                        if (isSelected) {
                          controler.selectedCategories.remove(category);
                        } else {
                          controler.selectedCategories.add(category[index]);
                        }
                      });
                    },
                    child: Padding(
