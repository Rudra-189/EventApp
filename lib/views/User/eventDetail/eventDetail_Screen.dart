                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(DateFormat('MM/dd/yyyy').format(data.date),style: TextStyle(color: Colors.white,fontSize: 14),),
                                    Text(DateFormat('hh:mm a').format(data.date),style: TextStyle(color: Colors.white,fontSize: 12),),
                                  ],
                                )
                              ],
                            ),
                            ...
                            Row(
                              children: [
                                ...
                                SizedBox(
                                  width: width * 0.7,
                                  child: Text(data.location,style: TextStyle(color: Colors.white,fontSize: 14),),
                                ),
                              ],
                            ),
                            SizedBox(height: 20,),
                            Row(
                              children: [
                                ...
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(organizerData.name,style: TextStyle(color: Colors.white,fontSize: 14),),
